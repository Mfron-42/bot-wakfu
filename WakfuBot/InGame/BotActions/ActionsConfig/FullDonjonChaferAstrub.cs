...
{
    public class FullDonjonChaferAstrubToFix : ABotActionConfig
    {
        public static new string Name { get; set; } = "Full Dj Chafer Astrub";

        public FullDonjonChaferAstrubToFix(WakfuDatas manager, Map map, Dictionary<long, APlayerService> players, DonjonsActions donjonsActions, int djLvl)
        ...
        public override void AddConfig()
        {
            ...
            AddConstantAction(PacketType.FightEnd, (FightEnd o) =>
            {
                ...
                if (SaleNumber == 4)
                {
                    ...
                    DonjonsActions.LeaveDjChaferAstrub();
                    SaleNumber = 1;
