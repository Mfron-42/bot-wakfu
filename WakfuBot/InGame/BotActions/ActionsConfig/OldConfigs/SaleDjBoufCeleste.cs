...
{
    public class SaleDjBoufCeleste
    {
        ...
        public SaleDjBoufCeleste(WakfuDatas manager, Map map, Dictionary<long, APlayerService> Players, DonjonsActions donjonsActions)
        {
            this.Map = map;
        ...
        public void Debug()
        {
            ...
            Manager.Send(TeleportAction.GetPacket(19804403439761152, 1));
        }
        ...
        private void Config()
        {
            ...
            Manager.AddConstantAction(PacketType.FightEnd, (FightEnd o) =>
            {
                    ...
                    DonjonsActions.LeaveSaleBoufCeleste(1);
