...
namespace WakfuBot.WakfuBot.Bot.Actions.ActionsConfig
{
    public class SaleDjAbraknyde
    {
        ...
        public SaleDjAbraknyde(WakfuDatas manager, Map map, Dictionary<long, APlayerService> Players, DonjonsActions donjonsActions)
        {
            this.Map = map;
        ...
        public void Debug()
        {
             Manager.Send(TeleportAction.GetPacket(18621328928261120, 1));
        }
        ...
        private void Config()
        {
            ...
            Manager.AddConstantAction(PacketType.FightEnd, (FightEnd o) =>
            {
                ...
                DonjonsActions.LeaveSaleArbraknyde(1);
