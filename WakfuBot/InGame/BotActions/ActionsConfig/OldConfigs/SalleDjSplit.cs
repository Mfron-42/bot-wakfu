...
namespace WakfuBot.WakfuBot.Bot.Actions.ActionsConfig
{
    public class SalleDjSplit
    {
        ...
        public SalleDjSplit(WakfuDatas manager, Map map, Dictionary<long, APlayerService> Players, DonjonsActions donjonsActions)
        {
            this.Map = map;
        ...
        public void Debug()
        {
            Manager.Send(TeleportAction.GetPacket(15716419207610112, 1));
        }
        ...
        private void Config()
        {
            ...
            {
                DonjonsActions.LeaveSaleSplit(20);
            });
