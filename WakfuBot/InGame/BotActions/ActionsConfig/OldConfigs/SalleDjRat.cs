...
namespace WakfuBot.WakfuBot.Bot.Actions.ActionsConfig
{
    public class SalleDjRat
    {
        ...
        public SalleDjRat(WakfuDatas manager, Map map, Dictionary<long, APlayerService> Players, DonjonsActions donjonsActions)
        {
            this.Map = map;
        ...
        private void Config()
        {
            ...
            Manager.AddConstantAction(PacketType.FightEnd, (FightEnd o) =>
            {
                ...
                DonjonsActions.LeaveSalleRat(1);
            });
