...
{
    public class SalleDjChat : ABotActionConfig
    {
        public static new string Name { get; set; } = "First salle dj chat";

        public SalleDjChat(WakfuDatas manager, Map map, Dictionary<long, APlayerService> players, DonjonsActions donjonsActions, int djLvl)
        ...
        public override void AddConfig()
        {
            ...
            AddConstantAction(PacketType.FightEnd, (FightEnd o) =>
            {
                if (o.FightId != Map.FightId)
                    return;
                DonjonsActions.LeaveFirstSalleChat();
